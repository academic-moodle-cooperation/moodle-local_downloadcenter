...
$string['downloadoptions:createindex'] = 'Create table of contents';
$string['downloadoptions:createindex_help'] = 'If enabled, the ZIP archive will contain an index.html file in the archive root. This table of contents links to the downloaded files and shows them grouped by course sections and subsections.';
...
$string['index:nofiles'] = 'No files were selected for download.';
$string['index:summary'] = 'This table of contents is part of the ZIP archive downloaded from <a href="{$a->courselink}">{$a->coursename}</a>.';
$string['index:title'] = 'Table of contents';
